...
public class Main extends Application {
	  ...
	  public void start(Stage primaryStage) {
		...
		new AnimationTimer() {
			// variable lastTick save time of previous frame
			long lastTick = 0;
	  ...
	  public static void tick(GraphicsContext gc) {
		  ...
		  // gameOver if snake touch the board;
		  switch(direction) {
		  case up:
			  snake.get(0).y--;
			  if(snake.get(0).y < 0)
		  ...
		  switch(foodcolor) {
		  case 0: fc = Color.YELLOW;
		  break;
		  case 1: fc = Color.GREEN;
		  break;
		  case 2: fc = Color.PINK;
		  break;
		  case 3: fc = Color.LIGHTBLUE;
		  break;
